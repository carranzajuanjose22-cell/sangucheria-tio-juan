...
type RegisterCloseRecord = {
  ...
  registerNumber: string;
  sales?: SaleRecord[];
  expenses?: { id: string, date: string, description: string, amount: number }[];
  initialCash?: number;
  openedAt?: string;
};
            ...
            <div className="p-6 overflow-y-auto flex-1 bg-white space-y-8">
              ...
              <div className="grid grid-cols-2 md:grid-cols-5 gap-4">
                ...
                <div className="bg-red-50/50 p-4 rounded-xl border border-red-100">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <p className="text-sm font-medium text-red-900">Gastos</p>
                      <p className="text-xl font-bold text-red-700">${selectedRegister.totalExpenses || 0}</p>
                    </div>
                  </div>
                </div>
                <div className="bg-yellow-50/50 p-4 rounded-xl border border-yellow-100">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-xl font-bold text-yellow-700">${(selectedRegister.initialCash || 0) + selectedRegister.totalIncome - (selectedRegister.totalExpenses || 0)}</p>
                    </div>
                  </div>
                </div>
              </div>
              ...
              {selectedRegister.sales && selectedRegister.sales.length > 0 ? (
                <div>
                  ...
                  {/* Expenses Detail */}
                  {selectedRegister.expenses && selectedRegister.expenses.length > 0 && (
                    <div className="mb-8">
                      <h4 className="text-lg font-bold text-gray-900 mb-4 flex items-center gap-2">
                        ...
                        {selectedRegister.expenses.map((expense) => (
                          <div key={expense.id} className="flex justify-between items-center p-4 bg-red-50/30 border border-red-100 rounded-xl">
                            <div>
                              ...
                              <p className="text-xs text-gray-500">
                                {new Date(expense.date).toLocaleTimeString("es-AR", { hour12: false })}
                              </p>
                            </div>
